...
//        patientCreationRequest1 = modelMapper.map(patient1, PatientCreationRequest.class);
//    }
//
//
//    @Test
//    void testCreatePatientSuccess() throws Exception {
//        String requestBody = mockObjectMapper.writeValueAsString(patientCreationRequest1);
//
//        when(mockPatientService.registerPatient(patientCreationRequest1))
//                .thenReturn(patient1);
//
...
//        String requestBody = mockObjectMapper.writeValueAsString(patientCreationRequest1);
//
//        when(mockPatientService.registerPatient(any(PatientCreationRequest.class)))
